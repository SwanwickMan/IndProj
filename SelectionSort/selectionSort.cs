// Dafny program selectionSort.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\andre\Desktop\IndProj\SelectionSort\selectionSort.dfy
// selectionSort.dfy
  ...
  public partial class __default {
    public static void SelectionSort(BigInteger[] a)
    {
      ...
      while ((_0_n) != (new BigInteger((a).Length))) {
        BigInteger _1_mindex;
        BigInteger _2_m;
        BigInteger _rhs0 = _0_n;
        BigInteger _rhs1 = (_0_n) + (BigInteger.One);
        _1_mindex = _rhs0;
        _2_m = _rhs1;
        while ((_2_m) != (new BigInteger((a).Length))) {
          if (((a)[(int)(_2_m)]) < ((a)[(int)(_1_mindex)])) {
            _1_mindex = _2_m;
          }
          _2_m = (_2_m) + (BigInteger.One);
        }
        BigInteger _rhs2 = (a)[(int)(_1_mindex)];
        BigInteger _rhs3 = (a)[(int)(_0_n)];
        BigInteger[] _lhs0 = a;
        BigInteger _lhs1 = _0_n;
        BigInteger[] _lhs2 = a;
        BigInteger _lhs3 = _1_mindex;
        _lhs0[(int)(_lhs1)] = _rhs2;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      (_0_a)[(int)((new BigInteger(2)))] = new BigInteger(9);
      (_0_a)[(int)((new BigInteger(3)))] = new BigInteger(3);
      (_0_a)[(int)((new BigInteger(4)))] = new BigInteger(7);
      (_0_a)[(int)((new BigInteger(5)))] = new BigInteger(2);
      (_0_a)[(int)((new BigInteger(6)))] = new BigInteger(4);
      (_0_a)[(int)((new BigInteger(7)))] = new BigInteger(6);
