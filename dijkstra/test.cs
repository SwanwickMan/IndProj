...
// Command-line arguments: run --no-verify d:\Andrew\Desktop\IndProj\test.dfy
// test.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_a;
      BigInteger _out0;
      _out0 = __default.triple(new BigInteger(10));
      _0_a = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("output ")).ToVerbatimString(false));
