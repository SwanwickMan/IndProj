// Dafny program quicksort.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\andre\Desktop\IndProj\ads2\QuickSort_ADS2\quicksort.dfy
// quicksort.dfy
...
method PARTITION(A: array<int>, p: int, r: int)
    returns (q: int)
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static BigInteger PARTITION(BigInteger[] A, BigInteger p, BigInteger r)
    {
      BigInteger q = BigInteger.Zero;
      BigInteger _0_x;
      _0_x = (A)[(int)(r)];
      BigInteger _1_i;
      _1_i = (p) - (BigInteger.One);
      BigInteger _2_j;
      _2_j = p;
      while ((_2_j) <= ((r) - (BigInteger.One))) {
        if (((A)[(int)(_2_j)]) <= (_0_x)) {
      ...
      __default.SWAP(A, (_1_i) + (BigInteger.One), r);
      q = (_1_i) + (BigInteger.One);
      return q;
    }
    public static void QUICKSORT(BigInteger[] A, BigInteger p, BigInteger r)
    {
      if ((p) < (r)) {
        BigInteger _0_q;
        BigInteger _out0;
        _out0 = __default.PARTITION(A, p, r);
        _0_q = _out0;
        __default.QUICKSORT(A, p, (_0_q) - (BigInteger.One));
        __default.QUICKSORT(A, (_0_q) + (BigInteger.One), r);
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      (_0_a)[(int)((new BigInteger(2)))] = new BigInteger(13);
      (_0_a)[(int)((new BigInteger(3)))] = new BigInteger(7);
      (_0_a)[(int)((new BigInteger(4)))] = new BigInteger(9);
      (_0_a)[(int)((new BigInteger(5)))] = new BigInteger(11);
      (_0_a)[(int)((new BigInteger(6)))] = BigInteger.One;
      ...
      __default.QUICKSORT(_0_a, BigInteger.Zero, new BigInteger(6));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Sorted List")).ToVerbatimString(false));
