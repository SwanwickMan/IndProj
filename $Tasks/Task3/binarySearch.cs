// Dafny program binarySearch.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\andre\Desktop\IndProj\BinarySearch\binarySearch.dfy
// binarySearch.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      (_0_a)[(int)((new BigInteger(6)))] = new BigInteger(13);
      BigInteger _1_item;
      _1_item = new BigInteger(5);
      ...
      BigInteger _2_foundIndex;
      BigInteger _out0;
      _out0 = __default.BinarySearch(_0_a, _1_item);
      _2_foundIndex = _out0;
      Dafny.Helpers.Print((_1_item));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" is at index ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_foundIndex));
    }
  }
